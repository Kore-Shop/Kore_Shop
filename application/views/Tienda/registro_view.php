...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">M E N U</a>
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-md-8">
            <h2>Registro de usuario</h2><br><br><br><br>
            <div class="col-12">
              <img src="<?= base_url() ?>assets1/Kore.PNG" style="width: 40%; height: 40%; margin: 15%; margin-top: -20%;">
            </div>
            <form class="col-12" style="opacity: 80%">
              ...
              <button type="submit" class="btn btn-light" name="aceptar" id="aceptar" style="border-radius: 40%; background-color: #e0fdff">
                <span class="glyphicon glyphicon-log-in"> REGISTRARSE</span>
              </button>
          </div>
